...
type Membership struct {
	gorm.Model
    UserID    string         `gorm:"type:uuid;not null;index:idx_user_company,priority:1" json:"user_id"`
    CompanyID string         `gorm:"type:uuid;not null;index:idx_user_company,priority:2" json:"company_id"`
